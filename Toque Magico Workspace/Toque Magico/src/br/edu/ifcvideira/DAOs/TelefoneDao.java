...
public class TelefoneDao {
	...
	public void deletarTelefone(Telefone te) throws Exception {
		...
		if (qntTelefones > 1) {
			...
			JOptionPane.showMessageDialog(null,
					"Impossível excluir o último número de telefone do cliente, você pode atualiza-lo", "Erro",
	...
	/**
	 * Retorna um número do cliente para backup quando for feita tentativa de
	 * exclusão do cliente
	 * 
	 * @param codigoCliente
